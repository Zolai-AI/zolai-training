...
## Shared Data
- Corpora, datasets, and bulk artifacts live in the container shared folder at `../data` (relative to this repo). This is **not** committed to this repo — it is a shared, gitignored directory (6.3G) across all six repos. Training outputs and checkpoints are stored here or on HuggingFace/Kaggle.
